function x = undistortCamera(x,K,r,t,sx,r_center,t_center,fastflat)
%Lens undistortion for image points when calibration matrix is known
%
...
%
%Inputs:
%   x        - Distorted points. Can be either unhomogenous 2xn or
%              homogenous 3xn.
...
%   fastflat - If true, fast method is used (interpolation). Default true
%
...
x = wnorm(K\x);
x = undistort(x,r,r_center,sx,t,t_center,fastflag);
x = wnorm(K*x);