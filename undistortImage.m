function outimg = undistortImage(img,K,r,t,sx,r_center,t_center)
%Undistorts distorted image, output image is same size as original.
%NOTE: This function uses distortCamera which uses function distort.
%      To undistort image, distortion parameters should (usually) have been 
%      calculated (minimized) using function undistortCamera
%
...
%
%Inputs:
%   img      - Distorted image. Can be color on gray valued
...
Xdistorted = distortCamera(XX,K,r,t,sx,r_center,t_center);
